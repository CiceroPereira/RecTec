...
class UpaImbiribeira extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:upaImbiribeira';
     ...
     * @var string
     */
    protected $description = 'Pegar os dados do pluvimetro da UPA Imbiribeira do banco de dados da apac e mandar para o thingsboard';
