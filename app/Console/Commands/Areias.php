...
class Areias extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:areia';
     ...
     * @var string
     */
    protected $description = 'Pegar os dados do pluvimetro de Areias do banco de dados da apac e mandar para o thingsboard';
